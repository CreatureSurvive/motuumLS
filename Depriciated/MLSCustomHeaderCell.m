#import "MLSCustomHeaderCell.h"

@implementation MLSCustomHeaderCell
...
- (id)init {
    ...
    if (self) {
        ...
        [self.headerLabel setText:@"motuumLS"];
        ...
        [self.subHeaderLabel setText:@"Your LockScreen, Your Way"];
        ...
        [self.subHeaderLabel2 setText:@"By: CreatureSurvive"];
